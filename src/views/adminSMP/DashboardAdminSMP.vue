...
import { getLaporanDashboardSmp } from '@/services/pengumumanService';
...
onMounted( async() => {
    try {
        ...
        if (periodeJalur.value) {
            const dashboardData = await getLaporanDashboardSmp(sekolah_id, periodeJalur.value.periode_jalur_id)
            console.log(dashboardData)
            totalSiswaTerdaftar.value = dashboardData.total_siswa_terdaftar
        ...
        <div class="md:w-full">
            <div class="card">
                <div class="flex flex-col gap-4">
                    <div class="text-xl">Selamat Datang Admin {{ sekolah_nama }}</div>
                    <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <Card class="flex-1 basis-1/5 border border-surface shadow-none">
                            <template #content>
                                <div class="flex justify-between gap-8">
                                    <div class="flex flex-col gap-10 w-[75%]">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <Card class="w-full md:w-[60%] border border-surface shadow-none">
                            ...
                            <template #content>
                                <DataTable :value="jadwals" tableStyle="min-width: 30vw">
